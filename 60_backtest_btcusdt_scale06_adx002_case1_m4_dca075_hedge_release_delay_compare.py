...
OUT_BASE = "60_backtest_btcusdt_scale06_adx002_case1_m4_dca075_hedge_release_delay_compare"
...
VARIANTS = [
    ...
    {"variant": "release3bull", "bullish_close_bars": 3, "shallow_gap_pct": -1.0},
...
def save_plot(curve_map: dict[str, pd.DataFrame], metrics_df: pd.DataFrame):
    ...
    ax_eq.set_title("60 Study: DCA 0.75% + Hedge Release Delay Variants + Fixed Case2")
...
def save_report(metrics_df: pd.DataFrame):
    ...
    lines: list[str] = []
    lines.append("# 60 Backtest: DCA 0.75% with Hedge Release Delay Variants")
    lines.append("")
    lines.append("## Setup")
    ...
    lines.append("- The key metric is whether smarter hedge release can preserve the study-56 CAGR boost while reducing its extra MDD.")
    lines.append("")
