...
SCRIPT_FILE = Path("09_backtest_btcusdt_triple_compare.py")
PLOT_FILE = Path("09_backtest_btcusdt_triple_compare.png")
CSV_FILE = Path("09_backtest_btcusdt_triple_compare.csv")
MD_FILE = Path("09_backtest_btcusdt_triple_compare.md")
...
def save_plot(results: list[BacktestResult]):
    ...
    ax_eq.set_title("09 Strategy Comparison: 02 vs 04 vs 08-best")
...
def save_md(results: list[BacktestResult], best_band: float):
    ...
    lines: list[str] = []
    lines.append("# 09 Strategy Evolution Comparison")
    lines.append("")
